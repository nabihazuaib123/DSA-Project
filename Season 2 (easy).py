...
def load_images():
    ...
    cover_image = tk.PhotoImage(file="shifty chronicles.png")  # Make sure cover image is in this path

    # Load each front image
    front_images.clear()
    image_files = [
        "S2cards_back/s2card_0.png", "S2cards_back/s2card_1.png", "S2cards_back/s2card_2.png",
        "S2cards_back/s2card_3.png", "S2cards_back/s2card_4.png", "S2cards_back/s2card_5.png",
        "S2cards_back/s2card_6.png", "S2cards_back/s2card_7.png"
    ]
